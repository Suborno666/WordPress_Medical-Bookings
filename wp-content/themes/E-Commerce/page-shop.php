...
//   }
// }
// echo "Number of Fruit Posts: " . $fruit_post_count;
...
?>
        ...
        <div class="container-fluid page-header py-5" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/cart-page-header-img.jpg');">
